...
-- ============================================================
-- Run this ONCE in the Neon SQL editor (Database Studio tab)
-- to create all tables immediately.
--
-- This script is fully idempotent:
--   - Uses CREATE TYPE IF NOT EXISTS (safe to re-run)
...
-- This table lets Prisma know migrations have been applied
-- so `prisma migrate deploy` won't try to re-apply them.
...
-- ─── DONE ────────────────────────────────────────────────────
-- All tables created. Your application should now work correctly.
-- The script is safe to run again — all statements are idempotent.
