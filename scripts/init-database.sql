-- ============================================================
-- Prausdit Research Lab - Complete Database Initialization SQL
-- ============================================================
-- Run this in the Neon SQL editor to initialize.
-- Fully idempotent: safe to re-run on an existing database.
-- Covers: Project scoping, author tracking, edit attribution.
-- ============================================================

-- ENUMS

DO $$ BEGIN CREATE TYPE "UserRole" AS ENUM ('super_admin', 'admin', 'developer', 'user');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN CREATE TYPE "ProjectType" AS ENUM ('MODEL', 'FRONTEND', 'BACKEND', 'CUSTOM');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN CREATE TYPE "StepStatus" AS ENUM ('PENDING', 'IN_PROGRESS', 'COMPLETED');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN CREATE TYPE "DocProgress" AS ENUM ('NOT_STARTED', 'IN_PROGRESS', 'COMPLETED');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN CREATE TYPE "DatasetType" AS ENUM ('CODE', 'TEXT', 'INSTRUCTION', 'QA', 'MIXED');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN CREATE TYPE "PreprocStatus" AS ENUM ('RAW', 'CLEANING', 'CLEANED', 'FORMATTED', 'AUGMENTED', 'READY');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN CREATE TYPE "ExperimentStatus" AS ENUM ('PENDING', 'RUNNING', 'COMPLETED', 'FAILED', 'CANCELLED');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN CREATE TYPE "QuantizationType" AS ENUM ('NONE', 'INT8', 'INT4', 'GPTQ', 'GGUF', 'AWQ');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN CREATE TYPE "ChatVisibility" AS ENUM ('team', 'private');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
CREATE TABLE IF NOT EXISTS "RoadmapStep" (
    ...
    CONSTRAINT "RoadmapStep_projectId_fkey"
...
CREATE TABLE IF NOT EXISTS "DocumentationPage" (
    ...
    CONSTRAINT "DocumentationPage_projectId_fkey"
        FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "Dataset" (
    ...
    CONSTRAINT "Dataset_projectId_fkey"
        FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "Experiment" (
    ...
    CONSTRAINT "Experiment_datasetId_fkey"
        FOREIGN KEY ("datasetId") REFERENCES "Dataset"("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "Experiment_projectId_fkey"
        FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "ModelVersion" (
    ...
    CONSTRAINT "ModelVersion_projectId_fkey"
        FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "ChatSession" (
    ...
    CONSTRAINT "ChatSession_projectId_fkey"
        FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- ADD MISSING COLUMNS TO EXISTING TABLES (migration, safe to re-run)

DO $$ BEGIN ALTER TABLE "RoadmapStep"       ADD COLUMN "createdWithAIModel" TEXT; EXCEPTION WHEN duplicate_column THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE "DocumentationPage" ADD COLUMN "createdWithAIModel" TEXT; EXCEPTION WHEN duplicate_column THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE "Dataset"           ADD COLUMN "createdWithAIModel" TEXT; EXCEPTION WHEN duplicate_column THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE "Experiment"        ADD COLUMN "createdWithAIModel" TEXT; EXCEPTION WHEN duplicate_column THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE "ModelVersion"      ADD COLUMN "createdWithAIModel" TEXT; EXCEPTION WHEN duplicate_column THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE "Note"              ADD COLUMN "createdWithAIModel" TEXT; EXCEPTION WHEN duplicate_column THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE "Project"           ADD COLUMN "createdByName"      TEXT; EXCEPTION WHEN duplicate_column THEN NULL; END $$;

-- Done. All tables created/updated. Safe to run again.
